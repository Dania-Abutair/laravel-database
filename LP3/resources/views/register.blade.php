      ...
      <div class="container">
        <div class="col-md-4 ml-auto mr-auto">
          <div class="card card-login card-plain">
            <form class="form" method="post" action="/students" enctype="multipart/form-data">
            @csrf
              ...
              <div class="card-body">
                ...
                <div class="input-group no-border input-lg">
                  ...
                  <input type="text" placeholder="NID..." class="form-control" name="national_id" value="{{old('national_id')}}"/>
                </div>
                @error('national_id')
                <div>
                <p style="color: red;font-size:0.7rem">{{$message}}</p>
                ...
                <div class="input-group no-border input-lg">
                  ...
                  <input type="text" placeholder="Mobile..." class="form-control" name="mobile" value="{{old('mobile')}}"/>
                </div>
                @error('mobile')
                <div>
                <p style="color: red;font-size:0.7rem">{{$message}}</p>
