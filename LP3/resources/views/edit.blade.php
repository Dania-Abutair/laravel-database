      ...
      <div class="container">
        <div class="col-md-4 ml-auto mr-auto">
          <div class="card card-login card-plain">
            <form class="form" method="post" action="/edit/{{$student['id']}}" enctype="multipart/form-data">
            @csrf
              ...
              <div class="card-body">
                <div class="input-group no-border input-lg">
                  ...
                  <input type="text" class="form-control" placeholder="Full Name..." name="fullname" value="{{$student['fullname']}}">
                </div>
                @error('fullname')
                <div>
                ...
                <p style="color: red;font-size:0.7rem">{{'The Fullname must be 4 part'}}</p>
                @endif
                </div>
                @enderror
                <div class="input-group no-border input-lg">
                  ...
                  <input type="text" placeholder="NID..." class="form-control" name="national_id" value="{{$student['national_id']}}"/>
                </div>
                @error('national_id')
                <div>
                <p style="color: red;font-size:0.7rem">{{$message}}</p>
                ...
                <div class="input-group no-border input-lg">
                  ...
                  <input type="email" placeholder="Email..." class="form-control" name="email" value="{{$student['email']}}" />
                </div>
                @error('email')
                <div>
                <p style="color: red;font-size:0.7rem">{{$message}}</p>
                ...
                <div class="input-group no-border input-lg">
                  ...
                  <input type="text" placeholder="Mobile..." class="form-control" name="mobile" value="{{$student['mobile']}}"/>
                </div>
                @error('mobile')
                <div>
                <p style="color: red;font-size:0.7rem">{{$message}}</p>
